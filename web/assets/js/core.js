...
function fld(oObj) {
    ...
    if (oObj !== null && oObj !== '0000-00-00 00:00:00') {
        ...
        if (site.dateFormats.js_sdate === 'dd-mm-yyyy')
            return '<div class="text-center">' + day + '-' + month + '-' + year + ' ' + time + '</div>';
        else if (site.dateFormats.js_sdate === 'dd/mm/yyyy')
            return '<div class="text-center">' + day + '/' + month + '/' + year + ' ' + time + '</div>';
        else if (site.dateFormats.js_sdate === 'dd.mm.yyyy')
            return '<div class="text-center">' + day + '.' + month + '.' + year + ' ' + time + '</div>';
        else if (site.dateFormats.js_sdate === 'mm/dd/yyyy')
            return '<div class="text-center">' + month + '/' + day + '/' + year + ' ' + time + '</div>';
        else if (site.dateFormats.js_sdate === 'mm-dd-yyyy')
            return '<div class="text-center">' + month + '-' + day + '-' + year + ' ' + time + '</div>';
        else if (site.dateFormats.js_sdate === 'mm.dd.yyyy')
            return '<div class="text-center">' + month + '.' + day + '.' + year + ' ' + time + '</div>';
...
function fsd(oObj) {
    ...
    if (oObj != null && oObj != '0000-00-00') {

        var aDate = oObj.split('-');

        if (site.dateFormats.js_sdate == 'dd-mm-yyyy')
            return '<div class="text-center">' + aDate[2] + '-' + aDate[1] + '-' + aDate[0] + '</div>';
        else if (site.dateFormats.js_sdate === 'dd/mm/yyyy')
            return '<div class="text-center">' + aDate[2] + '/' + aDate[1] + '/' + aDate[0] + '</div>';
        else if (site.dateFormats.js_sdate == 'dd.mm.yyyy')
            return '<div class="text-center">' + aDate[2] + '.' + aDate[1] + '.' + aDate[0] + '</div>';
        else if (site.dateFormats.js_sdate == 'mm/dd/yyyy')
            return '<div class="text-center">' + aDate[1] + '/' + aDate[2] + '/' + aDate[0] + '</div>';
        else if (site.dateFormats.js_sdate == 'mm-dd-yyyy')
            return '<div class="text-center">' + aDate[1] + '-' + aDate[2] + '-' + aDate[0] + '</div>';
        else if (site.dateFormats.js_sdate == 'mm.dd.yyyy')
            return '<div class="text-center">' + aDate[1] + '.' + aDate[2] + '.' + aDate[0] + '</div>';
...
function salary_status(x) {
    var y = x.split('__');

    if (y[0] == 1) {
        r = '<span class="label label-success">' +
            '<i class="fa fa-print"></i> Pagado</span';
    } else {
        r = '<span class="label label-danger">' +
            '<i class="fa fa-close"></i> Pagado parcialmente</span';
    }
    return r;
}
...
function city_status(x) {
    ...
    if (y[0] == 'T') {
        r = '<span class="label label-success">' +
            '<i class="fa fa-ok"></i> Activo</span';
    } else {
        r = '<span class="label label-danger">' +
...
function rrhh_status(x) {
    var y = x.split('__');

    if (y[0] == 'T') {
        r = '<span class="label label-success">' +
            '<i class="fa fa-print"></i> Activo</span';
    } else {
        r = '<span class="label label-danger">' +
            '<i class="fa fa-close"></i> Inactivo</span';
    }
