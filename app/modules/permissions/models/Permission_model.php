...
class Permission_model extends MY_Model {
    ...
    protected $validation_rules = [
        [
            'field' => 'name',
            'label' => 'lang:perm_name',
            'rules' => 'required|trim|max_length[255]',
        ],
        [
            'field' => 'description',
            'label' => 'lang:perm_description',
            'rules' => 'trim|max_length[100]',
        ],
        [
            'field' => 'status',
            'label' => 'lang:perm_status',
            'rules' => 'required|trim',
        ],
    ];
    ...
    public function countTotalPermissions($term = '') {
    ...
    public function getPermissions($term = '', $offset = 0, $limit = 10) {
        $this->db->from($this->table_name);
        if (!empty($term))
            $this->db->like('name', $term);
