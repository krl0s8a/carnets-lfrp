<?php $num_columns = 7; ?>
<?php echo form_open('buses/busesActions', array('id' => 'action-form')); ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= site_url('buses/create'); ?>"><i class="fa fa-plus-circle"></i>
                                <?= lang('op_create_bus'); ?>
                            </a>
                        </li>
                        <li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="BusTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="width: 30%; text-align:left;">
                                    <?php echo lang('lbl_registration'); ?>
                                </th>
                                <th style="width: 30%; text-align:left;">
                                    <?php echo lang('lbl_model'); ?>
                                </th>
                                <th style="width: 8%" class='status'>
