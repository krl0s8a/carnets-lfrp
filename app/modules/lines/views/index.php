<?php echo form_open('lines/linesActions', array('id' => 'action-form')); ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= site_url('lines/create'); ?>" id="create_new" data-toggle="modal"
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="#" class="bpo" title="<?= $this->lang->line('op_delete_line') ?>"
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                <p class="introtext">
                    <?php echo lang('info_cities'); ?>
                </p>
                <div class="table-responsive">
                    <table id="LineTable" cellpadding="0" cellspacing="0" border="0"
