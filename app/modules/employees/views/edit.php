        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <div style="max-width:200px; margin: 0 auto;">
                    <?=
                        $employee->avatar ? '<img alt="" src="' . base_url() . 'assets/uploads/avatars/thumbs/' . $employee->avatar . '" class="avatar">' :
                        '<img alt="" src="' . base_url() . 'assets/images/' . $employee->gender . '.png" class="avatar">';
                    ?>
                </div>
                <h4>
                    <?= lang('age'); ?>
        ...
        <div class="tab-content">
            <div id="personal" class="tab-pane fade in">
                <div class="box">
                    ...
                    echo form_hidden('people_id', $employee->people_id);
                    ?>
                    <div class="box-content">
                        <?php $this->load->view('employees/_personal'); ?>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
            <div id="laboral" class="tab-pane fade">
                <div class="box">
                    ...
                    ?>
                    <div class="box-content">
                        <?php $this->load->view('employees/_laboral'); ?>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
            <div id="contact" class="tab-pane fade">
                <div class="box">
                    ...
                    ?>
                    <div class="box-content">
                        <?php $this->load->view('employees/_contact'); ?>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
            <div id="doc" class="tab-pane fade">
                <div class="box">
                    ...
                    ?>
                    <div class="box-content">
                        <?php $this->load->view('employees/_doc'); ?>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
            <div id="avatar" class="tab-pane fade">
                <div class="box">
                    ...
                    <div class="box-content">
                        <?php $this->load->view('employees/_photo'); ?>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
