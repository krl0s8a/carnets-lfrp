function linkEdit(x) {
    var y = x.split('__');
    return '<a href="' + site.base_url + 'employees/edit/' + y[1] + '">' + y[0] + '</a>';
}
oTable = $('#table_personal').dataTable({
    ...
    "aoColumns": [{
        "bSortable": false,
        "mRender": checkbox
    }, { "mRender": linkEdit }, null, {"mRender":alignCenter}, {"mRender":alignCenter}, null, {"mRender":fsd}, null,{ "bSortable": false }]
});
