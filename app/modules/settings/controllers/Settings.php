...
class Settings extends MY_Controller {
    ...
    public function __construct() {
        ...
        Template::set('toolbar_title', lang('system_settings'));
    }
    ...
    private function saveSettings($extended_settings = array()) {
        ...
        $data = array(
            ...
            array('name' => 'site.status', 'value' => 1),
            ...
            array('name' => 'auth.allow_register', 'value' => 0),
            ...
            array('name' => 'auth.use_usernames', 'value' => 0),
            ...
            //array('name' => 'auth.password_force_numbers', 1),
            //array('name' => 'auth.password_force_symbols', 0),
            //array('name' => 'auth.password_force_mixed_case', 0),
            //array('name' => 'auth.password_show_labels', 1),
            array('name' => 'allow_print_number_ticket', 'value' => $this->input->post('allow_print_number_ticket') ? 1 : 0),
            array('name' => 'password_iterations', 'value' => 8),
