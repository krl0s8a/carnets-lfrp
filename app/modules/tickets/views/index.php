<?php echo form_open('tickets/ticketActions', array('id' => 'action-form')); ?>
<div class="box">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive">
                    <table id="TicketTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="width: 5%; text-align:left;">
                                    <?php echo lang('field_code') ?>
                                </th>
                                <th style="width: 50%; text-align:left;">
                                    <?php echo lang('field_name'); ?>
                                </th>
                                <th style="width: 15%; text-align:left;">
                                    <?php echo lang('field_price'); ?>
                                </th>
                                <th style="width: 15%; text-align:left;">
                                    <?php echo lang('field_quantity'); ?>
                                </th>
                                <th style="width: 5%" class='status'>
