                            ...
                            <?php foreach ($fields['actions'] as $action) : ?>
                                <td class="text-center">
                                    ...
                                    if (array_key_exists($action, $field_actions)) :
                                        ...
                                        $rand = rand();
                                        ?>
                                        <input type="checkbox" id="<?php echo $rand; ?>" name="role_permissions[]" class="" value="<?php echo $currentRolePermission['perm_id']; ?>"
                                        <?php
                                        if (isset($currentRolePermission['value']) && $currentRolePermission['value'] == 1) {
