...
class Roles extends MY_Controller {
    ...
    public function create() {
        ...
        Template::set('toolbar_title', lang('role_create'));
    ...
    public function edit() {
        ...
        Template::set('toolbar_title', isset($role->role_name) ? 'Editar ' . "{$title}: {$role->role_name}" : $title);
    ...
    public function permission_matrix() {
        ...
        Template::set_view('permission_matrix');
        Template::render();
    }
