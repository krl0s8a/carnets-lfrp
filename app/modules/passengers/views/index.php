<?php echo form_open('passengers/actions', array('id' => 'action-form')); ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('passengers/create'); ?>" data-toggle="modal"
                                data-target="#myModal"><i class="fa fa-plus-circle"></i>
                                <?= lang('op_create_customer'); ?>
                            </a></li>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                <p class="introtext">
                    <?php echo lang('info_schools'); ?>
                </p>
                <div class="table-responsive">
                    <table id="table_customers" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="width:10%">
                                    <?php echo lang('lbl_dni'); ?>
                                </th>
                                <th style="width:10%">
                                    <?php echo lang('lbl_type'); ?>
                                </th>
                                <th style="width:20%; text-align:left;">
                                    <?php echo lang('lbl_from_default'); ?>
                                </th>
                                <th style="width:20%; text-align:left;">
                                    <?php echo lang('lbl_to_default'); ?>
                                </th>
                                <th style="width: 5%">
...
<script type="text/javascript">
    var types_of_passenger = <?php echo json_encode(types_of_passenger()); ?>;
    var levelsCustomer = <?php echo json_encode(levelsCustomer()); ?>;
</script>