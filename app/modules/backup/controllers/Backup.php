...
class Backup extends MY_Controller {
    ...
    public function __construct(){
        ...
        Assets::add_module_js('backup', 'backup');
                ...
                if (file_exists($filename)) {
                    Template::set_message(
                        sprintf(
                            ...
                            html_escape(site_url("backup/get_backup/{$basename}")),
