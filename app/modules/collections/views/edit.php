<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-edit"></i><?= lang('edit_trip'); ?></h2>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        echo form_dropdown('drive_id', $choferes, set_select('drive_id', $trip->drive_id),array('class' => 'form-control'));
                                                    ?>
                                    </div>
                                </div>  
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <?php foreach ($tickets as $k => $v): ?>
                                        <label for="t-<?= $v->id ?>">
                                            <input type="checkbox" <?php echo in_array($v->id, $tickets_trip) ? ' checked="checked" ' : ''; ?> value="<?= $v->id ?>" name="tickets[]" id="t-<?= $v->id ?>">
                                            <?php echo $v->name; ?>
                                        </label>
                                    <?php endforeach ?>
                                    <?php endif ?>
