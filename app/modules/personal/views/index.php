<?php echo form_open('personal/actions', array('id' => 'action-form')); ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= site_url('personal/create'); ?>"><i class="fa fa-plus-circle"></i>
                                <?= lang('add_personal'); ?>
                            </a>
                        </li>
                        <li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-responsive">
                    <table id="table_personal" cellpadding="0" cellspacing="0" border="0"
