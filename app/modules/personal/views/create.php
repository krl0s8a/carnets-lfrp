    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open('personal/create', $attrib)
                    ?>
                <div class="row">
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    echo form_button(
                        ...
                        '<i class="fa fa-floppy-o"></i> ' . lang('create') . ' ' . lang('personal')
                    );
                    echo anchor('personal', lang('cancel'), array('class' => 'btn btn-link'))
                        ?>
                </div>
                <?= form_close(); ?>
            </div>
