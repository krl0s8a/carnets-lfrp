...
$activitiesReportsPage = 'activities';
$activitiesReportsUrl = site_url($activitiesReportsPage);

?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i>Actividades del sistema</h2>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <a href='<?php echo "{$activitiesReportsUrl}/{$pages['own']}"; ?>'>
                    <img src="<?php echo site_url('assets/images/activity-user.png'); ?>" alt='user icon' />
                </a>
            ...
            <div class="col-md-3">
                <a href='<?php echo "{$activitiesReportsUrl}/{$pages['user']}"; ?>'>
                    <img src="<?php echo site_url('assets/images/customers.png'); ?>" alt='users icon' />
                </a>
            ...
            <div class="col-md-3">
                <a href='<?php echo "{$activitiesReportsUrl}/{$pages['module']}"; ?>'>
                    <img src="<?php echo site_url('assets/images/product.png'); ?>" alt='modules icon' />
                </a>
            ...
            <div class="col-md-3">
                <a href='<?php echo "{$activitiesReportsUrl}/{$pages['date']}"; ?>'>
                    <img src="<?php echo site_url('assets/images/calendar.png'); ?>" alt='calendar icon' />
                </a>
