<?php echo form_open('banks/banksActions', array('id' => 'action-form')); ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-bank"></i>
            <?= lang('list_accounts_bank'); ?>
        </h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('banks/create'); ?>" data-toggle="modal" data-target="#myModal"><i
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive">
                    <table id="BanksTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <?php echo lang('lbl_bank') ?>
                                </th>
                                <th><?php echo lang('lbl_number') ?></th>
                                <th>
                                    <?php echo lang('lbl_status') ?>
                                </th>
