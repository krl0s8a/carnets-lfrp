...
if (!function_exists('_form_common')) {
    ...
    function _form_common($type = 'text', $data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        ...
        if (empty($defaults['name']) && is_array($data) && !empty($data['name'])
        ) {
        ...
        if (empty($label) && is_array($data) && !empty($data['label'])
        ) {
            $label = $data['label'];
            unset($data['label']);
        }
        ...
        if (empty($tooltip) && is_array($data) && !empty($data['tooltip'])
        ) {
        ...
        if (function_exists('form_error') && form_error($defaults['name'])) {
            $error = ' has-error';
            $tooltip = '<div class="help-block with-errors">' . form_error($defaults['name']) . '</div>';
        }
...
if (!function_exists('co_form_input')) {

    /**
     * Returns a properly templated text input field.
     *
     * @param array $data    The element name or an array of key/value pairs of
     * all attributes.
     * @param string $value   The value or blank if an array is passed to $data.
     * @param string $label   The label of the element.
     * @param string $extra   Any additional items to include, like Javascript.
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_input($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        return _form_common('text', $data, $value, $label, $extra, $tooltip);
    }

}

if (!function_exists('co_form_email')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_email($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        return _form_common('email', $data, $value, $label, $extra, $tooltip);
    }

}

if (!function_exists('co_form_password')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_password($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        return _form_common('password', $data, $value, $label, $extra, $tooltip);
    }

}

if (!function_exists('co_form_url')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_url($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        return _form_common('url', $data, $value, $label, $extra, $tooltip);
    }

}

if (!function_exists('co_form_telephone')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_telephone($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        return _form_common('tel', $data, $value, $label, $extra, $tooltip);
    }

}

if (!function_exists('co_form_number')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_number($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        return _form_common('number', $data, $value, $label, $extra, $tooltip);
    }

}

if (!function_exists('co_form_range')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_range($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        if (is_string($data)) {
...
if (!function_exists('co_form_color')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_color($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        return _form_common('color', $data, $value, $label, $extra, $tooltip);
    }

}

if (!function_exists('co_form_search')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_search($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        return _form_common('search', $data, $value, $label, $extra, $tooltip);
    }

}

if (!function_exists('co_form_date')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_date($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        return _form_common('date', $data, $value, $label, $extra, $tooltip);
    }

}

if (!function_exists('co_form_datetime')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_datetime($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        return _form_common('datetime', $data, $value, $label, $extra, $tooltip);
    }

}

if (!function_exists('co_form_month')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_month($data = '', $value = '', $label = '', $extra = '', $tooltip = '') {
        return _form_common('month', $data, $value, $label, $extra, $tooltip);
    }

}

if (!function_exists('co_form_dropdown')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_dropdown($data, $options = array(), $selected = array(), $label = '', $extra = '', $tooltip = '') {
        if (!is_array($data)) {
            $data = array('name' => $data);
        }
...
if (!function_exists('co_form_multiselect')) {
     ...
     * @return string The formatted input element, label tag and wrapping divs.
     */
    function co_form_multiselect($name = '', $options = array(), $selected = array(), $label = '', $extra = '', $tooltip = '') {
...
if (!function_exists('form_textarea')) {
    ...
    function form_textarea($data = array(), $value = '', $label = '') {
        return "
<div class='form-group>
    <label for='{$data['id']}'>{$label}</label>
    <textarea name='{$data['name']}' id='{$data['id']}' rows='2' class='form-control'>{$value}</textarea>
</div>";
    }

}
if (!function_exists('co_form_checkbox')) {
    # code...

    function co_form_checkbox($data = array(), $value = '', $check = false, $label = '') {
        $checked = $check ? ' checked = "checked" ' : '';
        return "
<div class='form-group'>
    <label for='{$data['id']}'>{$label} <input type='checkbox' name='{$data['name']}' value='$value' id='{$data['id']}' {$checked} /></label>
</div>";
    }
}