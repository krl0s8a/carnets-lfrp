...
if (!function_exists('formatDateTime')) {
     ...
     * @return string
     */
    function formatDateTime($datetime, $inputFormat, $outputFormat = "Y-m-d") {
        if (empty($datetime)) {
            return FALSE;
        }
...
if (!function_exists('formatTime')) {
     ...
     * @return string
     */
    function formatTime($time, $inputFormat, $outputFormat = "H:i:s") {
        $limiters = array(':');
        foreach ($limiters as $limiter) {
            if (strpos($inputFormat, $limiter) !== false) {
...
if (!function_exists('jqDateFormat')) {
...
if (!function_exists('jqTimeFormat')) {
     ...
     * @return string
     */
    function jqTimeFormat($phpFormat) {
...
if (!function_exists('jsDateFormat')) {
     ...
     * @return string
     */
    function jsDateFormat($phpFormat) {
...
if (!function_exists('age')) {
    ...
    function age($date) {
        if ($date == null || $date == '0000-00-00') {
            return 'Sin especificar fecha de nacimiento';
        } else {
            $fecha_nacimiento = new DateTime($date);
            $hoy = new DateTime();
...
if (!function_exists('dataLastMonthDay')) {
    function dataLastMonthDay() {
        $month = date('m');
        $year = date('Y');
...
if (!function_exists('dataFirstMonthDay')) {
    function dataFirstMonthDay() {
        $month = date('m');
        $year = date('Y');
